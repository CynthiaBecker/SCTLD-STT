...
```{r Install all necessary packages, message=FALSE, warning=FALSE, results='hide'}
...
```{r Final Filtering, message=FALSE, warning=FALSE, results = 'hide', fig.keep='all'}
...
ps2 <- ps %>%
  ...
  phyloseq::subset_taxa(Order !="Chloroplast" | is.na("Order")) %>%
...
```{r Figure 1, message=FALSE, results = 'hide', fig.keep='all'}
...
```{r Manuscript analysis PCoA Coral, message=FALSE, results = 'hide', fig.keep='last'}
#Upload data
...
```{r Dispersion Analysis, message=FALSE, results = 'hide', fig.keep='all'}
#import the ASV data that has been filtered for contaminants and low abundance reads. 
ASV <- read.table("ASV_STT2020_filt_decontam.txt", sep = "\t", row.names = 1, header = TRUE)
taxa <- as.matrix(read.table("taxonomy_STT2020_nospecies_filt_decontam.txt", sep = "\t", row.names = 1, header = TRUE))
metadata <- read.table("metadata_STT2020_filt_decontam.txt", sep = "\t", header = TRUE)
...
```{r Manuscript analysis PCoA Seawater, message=FALSE, results = 'hide', fig.keep='last'}
#Upload data
#import the ASV data that has been filtered for contaminants and low abundance reads. 
ASV <- read.table("ASV_STT2020_filt_decontam.txt", sep = "\t", row.names = 1, header = TRUE)
taxa <- as.matrix(read.table("taxonomy_STT2020_nospecies_filt_decontam.txt", sep = "\t", row.names = 1, header = TRUE))
...
```{r Bubble plot of disease-associated ASVs in coral tissue samples, message=FALSE, results = 'hide', fig.keep='all', fig.height=7, fig.width=10}
...
```{r Bubble plot of potential pathogens in the coral seawater, message=FALSE, results = 'hide', fig.keep='all', fig.height=7, fig.width=9}
...
```{r Manuscript Analysis PCoA All, message=FALSE, results = 'hide', fig.keep='last'}
#Upload data
#import the ASV data that has been filtered for contaminants and low abundance reads. 
ASV <- read.table("ASV_STT2020_filt_decontam.txt", sep = "\t", row.names = 1, header = TRUE)
taxa <- as.matrix(read.table("taxonomy_STT2020_nospecies_filt_decontam.txt", sep = "\t", row.names = 1, header = TRUE))
...
```{r PCoA of only healthy corals, message=FALSE, results = 'hide', fig.keep='last'}
...
```{r, message=FALSE, results = 'hide', fig.keep='all', fig.width=10, fig.height=6}
#import the ASV data that has been filtered for contaminants and low abundance reads. 
otu <- read.table("ASV_STT2020_filt_decontam.txt",sep="\t",header=TRUE, row.names=1)
taxon <- as.matrix(read.table("taxonomy_STT2020_nospecies_filt_decontam.txt", sep="\t", header=TRUE, row.names=1))
samples <- read.table("metadata_STT2020_filt_decontam.txt",sep="\t",header=T,row.names=1)
...
```{r Corncob analysis and graphing, message=FALSE, results = 'hide'}
otu <- read.table("ASV_STT2020_filt_decontam.txt",sep="\t",header=TRUE, row.names=1)
taxon <- as.matrix(read.table("taxonomy_STT2020_nospecies_filt_decontam.txt", sep="\t", header=TRUE, row.names=1))
samples <- read.table("metadata_STT2020_filt_decontam.txt",sep="\t",header=T,row.names=1)
...
```{r Figure S5, message=FALSE, results = 'hide', fig.keep='all'}
...
```{r Figure S6, message=FALSE, results = 'hide', fig.keep='all', fig.width=10, fig.height=8}
...
```{r Figure S7, message=FALSE, results = 'hide', fig.keep='all',fig.width=8, fig.height=4}
...
```{r Figure S8, message=FALSE, results = 'hide', fig.keep='all', fig.width=8, fig.height=7}
